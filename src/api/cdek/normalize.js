...
const createNodesFromEntities = ({entities, entityType/*, schemaType*/, createNode, createNodeId}) => {
...
module.exports.createNodesFromEntities = createNodesFromEntities;
...
module.exports.getValidKey = getValidKey;
